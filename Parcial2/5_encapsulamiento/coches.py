...
#el encapusulamiento o visibilidad es importante porque a traves de el es
#posible que python sepa como va a utilizar y manipular los atributos y 
#metodos de la clase

#atributo publico
atributo_publico="Soy una atributo publico"
#atributo privado
__atributo_privado__="Soy un atributo privado"
...
#Nota 2 para utilizar un atributo privado es necesario usarlo dentro de un metodo publico
...
def frenar(self):
    ...
    def getInfo(self):
       print(f"Marca: {self.getMarca()} {self.getColor()}, numeros de plazas: 
             {self.getPlazas()} \nModelo: {self.getModelo()} con una velocidad de 
             {self.getVelocidad()} Km/h y un potencia de {self.getCaballaje()} hp")  
